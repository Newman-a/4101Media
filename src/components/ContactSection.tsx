...
// Definir las props opcionales para personalizar el componente
...
const ContactSection: React.FC<ContactSectionProps> = ({ 
  title = "Hablemos", // Título por defecto
  subtitle = "¿Tienes un proyecto en mente? Nos encantaría escucharlo." // Subtítulo por defecto
}) => {
  ...
  // Hook de GSAP para manejar las animaciones de entrada del componente
  useGSAP(() => {
    gsap.from('.header-block-contact', { opacity: 0, y: 50, duration: 1, ease: 'power3.out', scrollTrigger: { trigger: '.header-block-contact', start: 'top 85%', once: true } });
    gsap.from('.contact-card', { opacity: 0, y: 50, duration: 1, ease: 'power3.out', stagger: 0.2, scrollTrigger: { trigger: '.contact-grid', start: 'top 85%', once: true } });
  }, { scope: containerRef });
  ...
  return (
    <div ref={containerRef}>
      <div className="header-block-contact text-center mb-16">
      ...
      <div className="contact-grid max-w-4xl mx-auto grid md:grid-cols-2 gap-12 bg-black p-8 md:p-12 rounded-2xl border border-white/10">
        ...
        <div className="contact-card">
          ...
          <ul className="mt-8 space-y-4 text-white/80">
            <li className="flex items-center">
                <IconMail className="w-6 h-6 mr-3 text-[#ff6600]" />
                <a href="mailto:4101mediavzla@gmail.com" className="hover:text-[#ff6600]">4101mediavzla@gmail.com</a>
            </li>
            <li className="flex items-center">
                <IconPhone className="w-6 h-6 mr-3 text-[#ff6600]" />
                <a href="tel:+584120748733" className="hover:text-[#ff6600]">+58 412-0748733</a>
            </li>
            <li className="flex items-center">
                ...
                <span>Coro, Falcón, Venezuela</span>
            </li>
          </ul>
        </div>
        ...
        <form onSubmit={handleSubmit} className="contact-card">
          ...
          {status && <p className="mt-4 text-sm text-center text-green-400 animate-fadeIn">{status}</p>}
