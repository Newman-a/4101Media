      ...
      <div ref={containerRef} className="pt-24 md:pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <div className="mission-vision-grid grid md:grid-cols-2 gap-12 mb-20">
            <div className="mission-vision-card bg-black p-8 rounded-2xl border border-white/10">
          ...
          <div className="text-center mb-12">
              <h2 className="text-4xl font-bold tracking-tight">Nuestros Valores</h2>
          </div>
          ...
          <div className="values-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {COMPANY_VALUES.map((value: Value) => (
              <div key={value.title} className="value-card bg-black p-6 rounded-lg border border-white/10 hover:border-[#ff6600] transition-colors duration-300">
